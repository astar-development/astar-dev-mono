...
public class FluentAssignmentsExtensionsShould
{
    ...
    [InlineData(-10)]
    [InlineData(0)]
    public void ReturnTheSameValueFromWillBeSetWhetherNegativePositiveOrZero(int value) => value.WillBeSet().ShouldBe(value);

    [Theory]
    [InlineData(10)]
    [InlineData(-10)]
    [InlineData(0)]
    public void ReturnTheSameValueFromIfItIsWhetherNegativePositiveOrZero(int value) => value.IfItIs().ShouldBe(value);
    ...
    [InlineData(-10)]
    [InlineData(0)]
    public void ReturnTheSameValueFromTheAndExtensionWhetherNegativePositiveOrZero(int value) => value.And().ShouldBe(value);

    [Theory]
    [InlineData(10)]
    [InlineData(-10)]
    [InlineData(0)]
    public void ReturnTheSameValueFromItIsGreaterThanWhenGreaterThanTheSpecifiedValue(int value) => value.ItIsGreaterThan(-11).ShouldBe(value);
    ...
    [InlineData(-10)]
    [InlineData(0)]
    public void ReturnTheSameValueFromItIsLessThanWhenLessThanTheSpecifiedValue(int value) => value.ItIsLessThan(value + 1).ShouldBe(value);
