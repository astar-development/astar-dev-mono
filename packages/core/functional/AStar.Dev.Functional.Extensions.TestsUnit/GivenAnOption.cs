namespace AStar.Dev.Functional.Extensions.TestsUnit;
...
public sealed class GivenAnOption
{
    ...
    public void when_option_is_some_then_map_transforms_the_value()
    {
        ...
        var result = option.Map(x => x.ToString(System.Globalization.CultureInfo.InvariantCulture));
    ...
    public void when_option_is_some_then_bind_returns_the_new_option()
    {
        ...
        var result = option.Bind(x => Option.Some(x.ToString(System.Globalization.CultureInfo.InvariantCulture)));
    ...
    public async Task when_option_is_some_then_map_async_transforms_the_value()
    {
        ...
        var result = await option.MapAsync(x => Task.FromResult(x.ToString(System.Globalization.CultureInfo.InvariantCulture)));
    ...
    public async Task when_a_task_of_option_is_some_then_map_async_transforms_the_value()
    {
        ...
        var result = await optionTask.MapAsync(x => x.ToString(System.Globalization.CultureInfo.InvariantCulture));
    ...
    public async Task when_a_task_of_option_is_some_then_map_async_with_an_async_mapper_transforms_the_value()
    {
        ...
        var result = await optionTask.MapAsync(x => Task.FromResult(x.ToString(System.Globalization.CultureInfo.InvariantCulture)));
    ...
    public async Task when_option_is_some_then_bind_async_returns_the_new_option()
    {
        ...
        var result = await option.BindAsync(x => Task.FromResult(Option.Some(x.ToString(System.Globalization.CultureInfo.InvariantCulture))));
    ...
    public async Task when_a_task_of_option_is_some_then_bind_async_with_a_sync_binder_returns_the_new_option()
    {
        ...
        var result = await optionTask.BindAsync(x => Option.Some(x.ToString(System.Globalization.CultureInfo.InvariantCulture)));
