...
public sealed record DeltaItem(string Id, string? Name, string? ParentId, DeltaItemType ItemType, string? PreviousName = null, long? Size = null, DateTimeOffset? LastModifiedDateTime = null);
...
public static class DeltaItemFactory
{
    ...
    public static DeltaItem Create(string id, string name, string? parentId, DeltaItemType itemType, string? previousName = null, long? size = null, DateTimeOffset? lastModifiedDateTime = null)
    {
        ArgumentException.ThrowIfNullOrWhiteSpace(id);
        ArgumentException.ThrowIfNullOrWhiteSpace(name);

        return new DeltaItem(id, name, parentId, itemType, previousName, size, lastModifiedDateTime);
    }
