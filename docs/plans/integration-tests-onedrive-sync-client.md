# Integration Tests — AStarDev.OneDriveSyncClient
...
Add to `AStarDev.OneDriveSyncClient.TestsIntegration.csproj`:
...
- `NSubstitute`
- `Testably.Abstractions.Testing`
- `AStarDev.OneDriveSyncClient.Data.Entities`
...
- `dotnet test --filter "FullyQualifiedName~TestsIntegration"` — all pass, none skipped.
