...
**File:** `apps/desktop/AStarDev.OneDriveSyncClient.TestsUnit/Data/Repositories/GivenASyncedItemRepository.cs`
...
| File                                                                                                 | Change                                |
| ---------------------------------------------------------------------------------------------------- | ------------------------------------- |
| `apps/desktop/AStarDev.OneDriveSyncClient/Data/Repositories/SyncedItemRepository.cs`                 | Add sort switch before `.Select(...)` |
| `apps/desktop/AStarDev.OneDriveSyncClient/appsettings.json`                                          | Version 0.11.2 → 0.12.0               |
| `apps/desktop/AStarDev.OneDriveSyncClient.TestsUnit/Data/Repositories/GivenASyncedItemRepository.cs` | 4 new sort-order test methods         |
