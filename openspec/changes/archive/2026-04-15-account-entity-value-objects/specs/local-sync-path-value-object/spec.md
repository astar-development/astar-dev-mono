...
The `AStarDev.OneDriveSyncClient.TestsUnit` project SHALL contain tests covering valid construction, null rejection, empty rejection, and whitespace rejection.
