...
3. **Webhook endpoint**
    ...
    - URL: `https://fab-4-kids.co.uk/api/webhooks/stripe`
...
| `PUBLIC_SITE_URL`       | `https://fab-4-kids.co.uk` (used for success/cancel redirect URLs) |
...
| --------------------- | ------------------------------------------------------ |
| `RESEND_API_KEY`      | `re_...`                                               |
| `RESEND_FROM_ADDRESS` | `orders@fab-4-kids.co.uk` (must match verified domain) |
