...
internal sealed class AccountBuilder
{
    ...
    public AccountBuilder WithDisplayName(string displayName) { _displayName        = displayName; return this; }
    public AccountBuilder WithEmail(string email)             { _email              = email; return this; }
    public AccountBuilder WithMicrosoftAccountId(string msId) { _microsoftAccountId = msId;  return this; }
