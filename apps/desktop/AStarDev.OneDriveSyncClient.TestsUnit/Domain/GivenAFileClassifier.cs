...
public sealed class GivenAFileClassifier
{
    private static FileClassificationCategory Category(string name, int level, bool isFamous = false, bool isInternet = false)
        => ((Ok<FileClassificationCategory, string>)FileClassificationCategoryFactory.Create(new(1), name, level, isFamous, isInternet, Option.None<FileClassificationCategoryId>(), false)).Value;
    ...
    private static FileClassificationCategory ChildCategory(int id, string name, int level, int parentId, bool isFamous = false, bool isInternet = false)
        => ((Ok<FileClassificationCategory, string>)FileClassificationCategoryFactory.Create(new(id), name, level, isFamous, isInternet, Option.Some(new FileClassificationCategoryId(parentId)), false)).Value;

    private static FileClassificationCategory RootCategory(int id, string name)
        => ((Ok<FileClassificationCategory, string>)FileClassificationCategoryFactory.Create(new(id), name, 1, false, false, Option.None<FileClassificationCategoryId>(), false)).Value;
