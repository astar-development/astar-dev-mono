...
public sealed class GivenAnApplicationInitializer
{
    ...
    private IAccountFilesViewServices accountFilesViewServices => new AccountFilesViewServices(_authService, _localizationService, _graphService, Substitute.For<ISyncRuleService>());
    private AccountFilesViewModelFactory accountFilesViewModelFactory => new(accountFilesViewServices, new FileSystemServices(_fileSystem, Substitute.For<IFileManagerService>()), Substitute.For<ILogger<AccountFilesViewModel>>(), new FolderTreeNodeViewModelFactory(_graphService, Substitute.For<ILogger<FolderTreeNodeViewModel>>(), _localizationService));
