...
namespace AStarDev.OneDriveSyncClient.Infrastructure.Theme;
...
{
    private static readonly Uri lightUri = new("avares://AStarDev.OneDriveSyncClient/Themes/Light.axaml");
    private static readonly Uri darkUri = new("avares://AStarDev.OneDriveSyncClient/Themes/Dark.axaml");
    private static readonly Uri hackerUri = new("avares://AStarDev.OneDriveSyncClient/Themes/Hacker.axaml");
