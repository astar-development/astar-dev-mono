### AStarDev.Clock — Avalonia Analog Clock (Light/Dark Theme)
...
- `src/AStarDev.Clock/` — Avalonia desktop application
...
```
dotnet publish src/AStarDev.Clock -c Release -r linux-x64 --self-contained false
```
