...
/// <param name="Tags">The tag data scraped from the image page.</param>
/// <param name="RawTags">The raw tag data scraped from the image page.</param>
public sealed record ScrapedImage(string ImageUrl, IReadOnlyList<string> DirectorySegments, string FilePrefix, IReadOnlyList<TagData> Tags, IReadOnlyList<TagData> RawTags) : ImagePageOutcome;

/// <summary>The image page's tags matched an ignore rule; the image should not be downloaded.</summary>
/// <param name="Tags">The tag data scraped from the image page before the skip was detected.</param>
/// <param name="RawTags">The raw tag data scraped from the image page before the skip was detected.</param>
public sealed record SkippedImage(IReadOnlyList<TagData> Tags, IReadOnlyList<TagData> RawTags) : ImagePageOutcome;
