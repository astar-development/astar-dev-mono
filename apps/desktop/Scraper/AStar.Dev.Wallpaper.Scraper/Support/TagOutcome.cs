...
public sealed record SkipImage(IReadOnlyList<TagData> Tags) : TagOutcome;
...
public sealed record Accept(string FilePrefix, IReadOnlyList<string> DirectorySegments, IReadOnlyList<TagData> Tags) : TagOutcome;
