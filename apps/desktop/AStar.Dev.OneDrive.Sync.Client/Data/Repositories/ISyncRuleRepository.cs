...
public interface ISyncRuleRepository
{
    ...
    /// <summary>Inserts or replaces the rule for the given account and remote path.</summary>
    Task UpsertAsync(AccountId accountId, string remotePath, RuleType ruleType, CancellationToken cancellationToken);
