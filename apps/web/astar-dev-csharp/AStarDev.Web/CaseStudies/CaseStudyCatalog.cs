...
public static class CaseStudyCatalog
{
    public static IReadOnlyList<CaseStudy> All { get; } =
    [
        CaseStudyFactory.Create(
            "global-affiliate-system",
            "Global Affiliate System",
            "Historical record, automated registration for new accounts. Award Winner",
            [".NET 2-5", "Azure App Service", "SQL Server", "Application Insights"],
            """
            ## The Problem

            A large, online gaming company, had a third-party affiliate system that was suboptimal. Details to be added shortly.
            ...
            Details to be added shortly. The important detail: the new Affiliate System won the award for "Best Affiliate System" the year it was released.
            """),
        CaseStudyFactory.Create(
            "distributed-pipeline-rebuild",
            "Distributed Pipeline Rebuild",
            "Replaced a fragile monolithic batch process with an event-driven architecture, cutting deployment risk and halving on-call incidents.",
            [".NET 7", "Azure Functions", "Cosmos DB", "Application Insights"],
            """
            ## The Problem
